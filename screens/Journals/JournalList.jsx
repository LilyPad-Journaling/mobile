...
function Entry(props) {
  ...
  const Input = (props) => {
    const { keyboardType, value, onChangeText } = props;
  ...
  return (
    <View>
      ...
      >
        <View>
          <Text style={{ ...styles.entryTitle, color: color.primaryText }}>
            {props.title}
          </Text>
      ...
      <Modal isVisible={isModalVisible}>
        <View style={styles.container}>
          <Text style={{ marginBottom: 10, fontSize: 20, fontWeight: "bold" }}>Enter PIN</Text>
